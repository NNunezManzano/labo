...
# Estategia para el dataset datafriting con cero fijo
# limpio la memoria
...
dataset_input <- paste0("./exp/", PARAM$exp_input, "/dataset_fe_cerofijo.csv.gz")
