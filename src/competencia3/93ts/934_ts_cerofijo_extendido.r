...
PARAM <- list()
PARAM$experimento <- "TS9257"

PARAM$exp_input <- "FE9250"

PARAM$future <- c(202107)

PARAM$final_train <- c(202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
...
dataset_input <- paste0("./exp/", PARAM$exp_input, "/dataset_cerofijo.csv.gz")
