...
PARAM <- list()
PARAM$experimento <- "TS1004"

PARAM$exp_input <- "FE1004"

PARAM$future <- c(202109)

PARAM$final_train <- c(201910, 201911, 202011, 202012, 202101, 202102, 202103, 202106, 202107)

PARAM$train$training <- c(201910, 201911, 201912, 202010, 202011, 202012, 202101, 202102, 202103)
