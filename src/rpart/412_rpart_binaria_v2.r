...
#Completo valores nulos en campo Visa/Master consumototal
dataset[
...
#dir.create( "./exp/" )
dir.create( "./exp/KA4126" )


for( corte  in  c( 7500, 8500, 9000, 9500, 11000 ) )
{
  ...
  fwrite( dfinal[ , list(numero_de_cliente, Predicted) ], #solo los campos para Kaggle
           file= paste0( "./exp/KA4126/KA4126_005_",  corte, ".csv"),
           sep=  "," )
}
