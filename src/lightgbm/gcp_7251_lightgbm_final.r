...
PARAM$finalmodel$max_bin           <-     85
PARAM$finalmodel$learning_rate     <-     0.00510515089381016  #0.0142501265
PARAM$finalmodel$num_iterations    <-     514  #615
PARAM$finalmodel$num_leaves        <-     739  #784
PARAM$finalmodel$min_data_in_leaf  <-     73  #5628
PARAM$finalmodel$feature_fraction  <-     0.416253862759325 #0.8382482539
