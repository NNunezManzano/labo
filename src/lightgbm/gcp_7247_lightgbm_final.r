...
PARAM$finalmodel$learning_rate     <-     0.0125661692559436  #0.0142501265
PARAM$finalmodel$num_iterations    <-     380  #615
PARAM$finalmodel$num_leaves        <-     197  #784
PARAM$finalmodel$min_data_in_leaf  <-     1592  #5628
PARAM$finalmodel$feature_fraction  <-     0.731054330213521  #0.8382482539
