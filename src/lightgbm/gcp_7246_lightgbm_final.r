...
PARAM$finalmodel$learning_rate     <-     0.0052107568307604  #0.0142501265
PARAM$finalmodel$num_iterations    <-     1658  #615
PARAM$finalmodel$num_leaves        <-     383  #784
PARAM$finalmodel$min_data_in_leaf  <-     1653  #5628
PARAM$finalmodel$feature_fraction  <-     0.344092748241762 #0.8382482539
