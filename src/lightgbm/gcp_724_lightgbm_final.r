...
PARAM$finalmodel$learning_rate     <-     0.00584555752446588  #0.0142501265
PARAM$finalmodel$num_iterations    <-     1424  #615
PARAM$finalmodel$num_leaves        <-     293  #784
PARAM$finalmodel$min_data_in_leaf  <-     354  #5628
PARAM$finalmodel$feature_fraction  <-     0.34832208971327  #0.8382482539
