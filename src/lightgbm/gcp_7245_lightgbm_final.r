...
PARAM$finalmodel$learning_rate     <-     0.0348284011221351  #0.0142501265
PARAM$finalmodel$num_iterations    <-     572  #615
PARAM$finalmodel$num_leaves        <-     706  #784
PARAM$finalmodel$min_data_in_leaf  <-     3421  #5628
PARAM$finalmodel$feature_fraction  <-     0.364707025007032  #0.8382482539
