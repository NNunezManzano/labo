...
PARAM$finalmodel$learning_rate     <-     0.0165487588257997  #0.0142501265
PARAM$finalmodel$num_iterations    <-     668  #615
PARAM$finalmodel$num_leaves        <-     292  #784
PARAM$finalmodel$min_data_in_leaf  <-     1628  #5628
PARAM$finalmodel$feature_fraction  <-     0.511093199388623  #0.8382482539
