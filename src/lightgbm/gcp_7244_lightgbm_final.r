...
PARAM$finalmodel$learning_rate     <-     0.0111268432905751  #0.0142501265
PARAM$finalmodel$num_iterations    <-     1347  #615
PARAM$finalmodel$num_leaves        <-     492  #784
PARAM$finalmodel$min_data_in_leaf  <-     709  #5628
PARAM$finalmodel$feature_fraction  <-     0.731513036776023  #0.8382482539
