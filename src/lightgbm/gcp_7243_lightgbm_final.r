...
PARAM$finalmodel$learning_rate     <-     0.0148253337636901  #0.0142501265
PARAM$finalmodel$num_iterations    <-     722  #615
PARAM$finalmodel$num_leaves        <-     438  #784
PARAM$finalmodel$min_data_in_leaf  <-     77  #5628
PARAM$finalmodel$feature_fraction  <-     0.391481154676567  #0.8382482539
