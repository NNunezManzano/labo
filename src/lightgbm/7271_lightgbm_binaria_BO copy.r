...
PARAM$trainingstrategy$semilla_azar <- 104659 # Aqui poner la propia semilla 103319 / 104659 / 204019 / 307067 / 700067
...
PARAM$hyperparametertuning$semilla_azar <- 104659 # Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy 103319 / 104659 / 204019 / 307067 / 700067
...
EstimarGanancia_lightgbm <- function(x) {
  ...
  param_basicos <- list(
    ...
    verbosity = -100,
    max_depth = -1, # por ahora, lo dejo fijo
...
dataset <- dataset[foto_mes %in% PARAM$input$training, head(.SD, 10000)]
